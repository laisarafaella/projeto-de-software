...
<head>
  ...
  <title>Sportsync - Detalhes de Paulo Victor</title>
</head>
...
<body class="inter">
  ...
  <div class="tituloPag">
    ...
    Mais detalhes de&nbsp;<span class="break" id="destaque1">Paulo Victor</span>
  </div>


  <main class="detalhes-container">
    <div class="coluna-esquerda">
        <img src="./assets/atleta2.png" alt="Atleta 2" class="atleta-foto">
        <h2 class="nome-atleta">Paulo Victor</h2>
        <div class="caixa-biografia">
            Estou determinado a me tornar um dos melhores no tênis. Treino diariamente para alcançar esse objetivo, mas luto com a falta de equipamentos de qualidade para continuar competindo em alto nível.
        </div>
    </div>

    <div class="coluna-direita informacoes-detalhadas">
        <p><strong>Categoria:</strong> Tênis</p>
        <p><strong>Necessidade:</strong> Equipamentos</p>
        <p><strong>Objetivo:</strong> Competições nacionais e internacionais.</p>

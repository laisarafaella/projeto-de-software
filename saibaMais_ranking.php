...
$atleta_id = isset($_GET['id']) ? $_GET['id'] : null;
$atleta_encontrado = null;
...
<div class="icon-menu" id="icon-menu">
    ...
    <div class="nav-links" id="nav-links">
        ...
        <ul>
            ...
            <li>
                <a style="text-decoration: none;" href="index.php" id="nav-links-home">Home</a>
            </li>
            <li>
                <a style="text-decoration: none;">Sobre</a>
            </li>
...
<body>
    <div class="container-atleta">
        <div class="atleta-info">
            <img src="<?php echo $atleta_encontrado['foto']; ?>" alt="Foto do Atleta">
            <h2><?php echo $atleta_encontrado['nome']; ?></h2>
            <p class="sobre">Sobre: <?php echo $atleta_encontrado['sobre']; ?></p>
        </div>
